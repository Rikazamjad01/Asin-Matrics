    ...
    <div className='flex max-md:flex-col md:items-center gap-6 plb-6'>
      <div className='md:is-8/12'>
        <div className='flex items-baseline gap-1 mbe-2'>
          ...
          <Typography variant='h4'>Store Manager 👋🏻</Typography>
        </div>
        <div className='mbe-4'>
          <Typography>Your store performance this week is excellent. Keep up</Typography>
          <Typography>the great work and exceed your sales targets!</Typography>
        </div>
      ...
      <div className='flex justify-between md:is-4/12'>
        <div className='flex flex-col justify-between gap-6'>
          <div>
            ...
            <Typography>Orders summary</Typography>
          </div>
          <div>
            <Typography variant='h4' className='mbe-2'>
              1,845<span className='text-textSecondary'> orders</span>
            </Typography>
