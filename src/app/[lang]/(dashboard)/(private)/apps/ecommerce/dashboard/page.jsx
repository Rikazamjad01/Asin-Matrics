...
import BarProfitChart from '@/views/apps/ecommerce/dashboard/BarOrders'
import RadialExpensesChart from '@views/apps/ecommerce/dashboard/RadialExpensesChart'
import TotalIncome from '@/views/apps/ecommerce/dashboard/TotalAdSpend'
...
import BarOrdersChart from '@/views/apps/ecommerce/dashboard/BarOrders'
      ...
      <Grid size={{ xs: 12, lg: 4 }}>
        <Grid container spacing={6}>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3, lg: 6 }}>
            <Vertical
              title='Clicks'
              imageSrc='/images/cards/arrow.png'
              stats='12.8k'
              trendNumber={62}
              trend='positive'
            />
